...
from samples import targetlumi, lumiStr, systListShort, systListFull, samples_data, samples_signal, samples_electroweak3, samples_electroweak4, samples_ttbarx3, samples_ttbarx4, uncorrList_sf, yearList, samples_nonprompt, samples_conversion, samples_higgs
from utils import *
        ...
        for cat in catList:
                ...
                for proc in bkgProcs:
                        ...
                        for bkg in bkgGrp:
                                ...
                                doMuRF = True
                                #print('Working on bkg:',bkg)                                
                                # Group nominal and correlated systs for each year
                                if isFirstHistDir[year]:
                                        #print(f'Found firsthist: {histoPrefix}_{bkgPrefix}')
